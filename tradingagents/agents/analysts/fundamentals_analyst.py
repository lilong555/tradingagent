        ...
        prompt = ChatPromptTemplate.from_messages(
            [
                (
                    ...
                    " If you are unable to fully answer, that's OK; we have different tools"
                    " will help where you left off. Execute what you can to make progress."
                    " If you or any others has the FINAL TRANSACTION PROPOSAL: **BUY/HOLD/SELL** or deliverable,"
